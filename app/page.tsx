  ...
  return (
    <div className="min-h-screen bg-background-default">
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        {/* Demo Image */}
        <div className="rounded-2xl overflow-hidden shadow-soft hover:shadow-glow transition-shadow duration-300 mb-16">
          <Image
            width={1306}
            height={1229}
        ...
        <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center pb-2 leading-normal">What Our Users Say</h2>
          <Testimonials />
        </div>
