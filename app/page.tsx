...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#9C59EE] via-[#679AD1] to-[#1E1E1E]">

      <main className="flex-grow flex items-center justify-center p-10">
        <div className="w-full max-w-4xl bg-[#1E1E1E] p-6 rounded-xl shadow-lg text-white space-y-6">
          ...
          <h2 className="text-2xl text-[#9C59EE] text-center">Use AI instead!</h2>
